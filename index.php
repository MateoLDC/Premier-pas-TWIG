...
<body>
    <div class="bg-img1 size1 flex-w flex-c-m p-t-20 p-b-55 p-l-15 p-r-15">
        <div class="wsize1 bor1 bg1 p-b-45 p-l-15 p-r-15 p-t-20 respon1">
            ...
            <p class="txt-center m1-txt1 p-t-33 p-b-68">Exercice TWIG avec PHP</p>
                ...
                ?>
                    <div class="card col-4">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                Bonjour, mon nom est
                                <?php echo ucfirst($utilisateur['name']['first']) . " " . strtoupper($utilisateur['name']['last']); ?>
                            </h5>
                            <p class="card-text">
                                J'habite "<?php echo strtoupper($utilisateur['location']['state']); ?>",
                                dans une ville qui s'appelle "<?php echo strtoupper($utilisateur['location']['city']); ?>""<br /><br />
                            </p>
                            <p class="card-text">
